...
<body>
    ...
    <main>
        ...
        <div class="talleres-grid">
            <div class="taller1">
                <img src="/mvc_sds/src/datos.jpeg" alt="">
                <h3>Toma de decisiones estrategicas basadas en datos</h3>
                <p>Este dio inicio a las 8 am y fue impartida por el Msc. Enrique Cortez</p>
            </div>
        <div class="taller2">
            <img src="/mvc_sds/src/laravel.jpeg" alt="">
